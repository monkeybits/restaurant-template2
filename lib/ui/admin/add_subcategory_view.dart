...
class AddSubcategoryView extends StatefulWidget {
  const AddSubcategoryView({Key key, @required this.animationController})
      : super(key: key);
...
class _FavouriteProductListView extends State<AddSubcategoryView>
