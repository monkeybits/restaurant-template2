                ...
                RefreshIndicator(
                  child: CustomScrollView(
                      ...
                      slivers: <Widget>[
                        ...
                        SliverToBoxAdapter(
                          child: _SelfPickUpWidget()) 
                          else SliverToBoxAdapter(child: Container(),),
                        SliverToBoxAdapter(
      ...
      child: Column(children: <Widget>[
        Padding(
            ...
            _TransactionNoTextWidget(
              transationInfoText: Utils.getString(context, 'transaction_detail__self_pick_up'),
              title:
                  Utils.getString(context, 'transaction_detail__type') + ' :',
            ),
    ...
    return Container(
        ...
        child: Column(
          children: <Widget>[
            ...
            _TransactionNoTextWidget(
              transationInfoText: '${transaction.deliveryPickupDate} ${transaction.deliveryPickupTime}',
              title:
