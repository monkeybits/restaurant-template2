                  ...
                  child: Container(
                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        _dividerWidget,
                        pref.shared.getString('user_role') == 'admin'
                            ? _AdminPanelWidget(
                                userProvider: provider,
                              )
                            : _dividerWidget,
...
class _AdminPanelWidget extends StatelessWidget {
  const _AdminPanelWidget({this.userProvider});
  final UserProvider userProvider;
  @override
  Widget build(BuildContext context) {
    const Widget _sizedBoxWidget = SizedBox(
...
class _AdminPanel2Widget extends StatelessWidget {
  const _AdminPanel2Widget({this.userProvider});
  final UserProvider userProvider;
  @override
  Widget build(BuildContext context) {
    const Widget _sizedBoxWidget = SizedBox(
