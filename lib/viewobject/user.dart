  ...
  User fromMap(dynamic dynamicData) {
    if (dynamicData != null) {
      return User(
        ...
        isShopAdmin: dynamicData['is_shop_admin'] == null ? '' : dynamicData['is_shop_admin'],
        facebookId: dynamicData['facebook_id'] == null ? '' : dynamicData['facebook_id'],
        googleId: dynamicData['google_id'] == null ? '' : dynamicData['google_id'],
        userName: dynamicData['user_name'] == null ? '' : dynamicData['user_name'],
        userEmail: dynamicData['user_email'] == null ? '' : dynamicData['user_email'],
        userPhone: dynamicData['user_phone'] == null ? '' : dynamicData['user_phone'],
        userPassword: dynamicData['user_password'] == null ? '' : dynamicData['user_password'],
        userAboutMe: dynamicData['user_about_me'] == null ? '' : dynamicData['user_about_me'],
        userCoverPhoto: dynamicData['user_cover_photo'] == null ? '' : dynamicData['user_cover_photo'],
        userProfilePhoto: dynamicData['user_profile_photo'] == null ? '' : dynamicData['user_profile_photo'],
        roleId: dynamicData['role_id'] == null ? '' : dynamicData['role_id'],
        status: dynamicData['status'] == null ? '' : dynamicData['status'],
        isBanned: dynamicData['is_banned'] == null ? '' : dynamicData['is_banned'],
        addedDate: dynamicData['added_date'] == null ? '' : dynamicData['added_date'],
        address: dynamicData['user_address'] == null ? '' : dynamicData['user_address'],
        userLat: dynamicData['user_lat'] == null ? '' : dynamicData['user_lat'],
        userLng: dynamicData['user_lng'] == null ? '' : dynamicData['user_lng'],
        deviceToken: dynamicData['device_token'] == null ? '' : dynamicData['device_token'],
        code: dynamicData['code'] == null ? '' : dynamicData['code'],
        verifyTypes: dynamicData['verify_types'] == null ? '' : dynamicData['verify_types'],
        addedDateStr: dynamicData['added_date_str'] == null ? '' : dynamicData['added_date_str'],
