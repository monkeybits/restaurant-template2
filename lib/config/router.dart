...
import 'package:flutterrestaurant/ui/admin/add_category_container.dart';
import 'package:flutterrestaurant/ui/admin/add_category_view.dart';
import 'package:flutterrestaurant/ui/admin/add_product_container.dart';
import 'package:flutterrestaurant/ui/admin/add_subcategory_container.dart';
...
Route<dynamic> generateRoute(RouteSettings settings) {
  switch (settings.name) {
    ...
    case '${RoutePaths.addCategory}':
      return PageRouteBuilder<dynamic>(
          pageBuilder: (_, Animation<double> a1, Animation<double> a2) =>
              AddCategoryContainerView());

    case '${RoutePaths.addSubcategory}':
      return PageRouteBuilder<dynamic>(
          pageBuilder: (_, Animation<double> a1, Animation<double> a2) =>
              AddSubcategoryContainerView());

    case '${RoutePaths.addProduct}':
      return PageRouteBuilder<dynamic>(
          pageBuilder: (_, Animation<double> a1, Animation<double> a2) =>
              AddProductContainerView());
